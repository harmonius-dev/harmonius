// gcraft_surface.cpp - Surface and swapchain implementation
...
extern "C" GCError GCSurfaceCreate(GCPlatformPtr platform_ptr, const GCSurfaceDesc* desc,
...
extern "C" GCError GCSwapchainCreate(GCDevicePtr device_ptr, const GCSwapchainDesc* desc,
    ...
    *out_swapchain = reinterpret_cast<GCSwapchainPtr>(swapchain.release());
    return ok();
}
...
extern "C" GCError GCSwapchainAcquireNext(GCSwapchainPtr swapchain_ptr,
                                          GCTimelineSemaphorePtr signal_semaphore_ptr,
    ...
    if (result == ::vk::Result::eErrorOutOfDateKHR || result == ::vk::Result::eSuboptimalKHR) {
        return error(GC_E_INVALID_STATE, "swapchain out of date");
    }
    if (result != ::vk::Result::eSuccess) {
        return from_vk_result(result);
    }
...
extern "C" GCError GCSwapchainPresent(GCSwapchainPtr swapchain_ptr,
                                       GCTimelineSemaphorePtr wait_semaphore_ptr,
                                       uint64_t wait_value) {
