...
extern "C" GCError GCRenderPipelineCreate(GCDevicePtr device_ptr, const GCRenderPipelineDesc* desc,
    ...
    *out_pipeline = reinterpret_cast<GCRenderPipelinePtr>(pipeline.release());
    return ok();
}
...
extern "C" GCError GCComputePipelineCreate(GCDevicePtr device_ptr, const GCComputePipelineDesc* desc,
    ...
    pipeline->pipeline = std::move(vk_pipeline);
    *out_pipeline = reinterpret_cast<GCComputePipelinePtr>(pipeline.release());
    return ok();
}
...
extern "C" GCError GCMeshPipelineCreate(GCDevicePtr device_ptr, const GCMeshPipelineDesc* desc,
    ...
    if (!(device->features & GC_FEATURE_MESH_SHADER_BIT)) {
    ...
    pipeline->pipeline = std::move(vk_pipeline);
    *out_pipeline = reinterpret_cast<GCMeshPipelinePtr>(pipeline.release());
    return ok();
}
...
extern "C" GCError GCRayTracingPipelineCreate(GCDevicePtr device_ptr, const GCRayTracingPipelineDesc* desc,
    ...
    if (!(device->features & GC_FEATURE_RAY_TRACING_BIT)) {
    ...
    *out_pipeline = reinterpret_cast<GCRayTracingPipelinePtr>(pipeline.release());
    return ok();
}
...
extern "C" GCError GCAccelerationStructureCreate(GCDevicePtr device_ptr, const GCAccelerationStructureDesc* desc,
    ...
    *out_as = reinterpret_cast<GCAccelerationStructurePtr>(as.release());
    return ok();
}

extern "C" GCError GCAccelerationStructureDestroy(GCAccelerationStructurePtr as_ptr) {
    if (as_ptr) {
