...
extern "C" GCError GCCommandBufferCreate(GCDevicePtr device_ptr, GCCommandBufferPtr* out_command_buffer) {
    ...
    *out_command_buffer = reinterpret_cast<GCCommandBufferPtr>(cmd.release());
    return ok();
}
...
extern "C" GCError GCCommandBufferBegin(GCCommandBufferPtr command_buffer) {
    ...
    if (cmd->is_recording) return error(GC_E_INVALID_STATE, "already recording");
...
extern "C" GCError GCCommandBufferEnd(GCCommandBufferPtr command_buffer) {
    ...
    auto* cmd = reinterpret_cast<CommandBuffer*>(command_buffer);
    if (!cmd->is_recording) return error(GC_E_INVALID_STATE, "not recording");
...
extern "C" GCError GCCommandBeginRenderPass(GCCommandBufferPtr command_buffer, const GCRenderPassDesc* desc) {
...
extern "C" GCError GCCommandBindRenderPipeline(GCCommandBufferPtr command_buffer, GCRenderPipelinePtr pipeline) {
...
extern "C" GCError GCCommandBindMeshPipeline(GCCommandBufferPtr command_buffer, GCMeshPipelinePtr pipeline) {
    if (!command_buffer || !pipeline) return invalid_argument("command_buffer or pipeline is NULL");
...
extern "C" GCError GCCommandBindComputePipeline(GCCommandBufferPtr command_buffer, GCComputePipelinePtr pipeline) {
    if (!command_buffer || !pipeline) return invalid_argument("command_buffer or pipeline is NULL");
...
extern "C" GCError GCCommandBindRayTracingPipeline(GCCommandBufferPtr command_buffer, GCRayTracingPipelinePtr pipeline) {
    if (!command_buffer || !pipeline) return invalid_argument("command_buffer or pipeline is NULL");
...
extern "C" GCError GCCommandBindDescriptorSet(GCCommandBufferPtr command_buffer, GCPipelineLayoutPtr layout,
...
extern "C" GCError GCCommandPushConstants(GCCommandBufferPtr command_buffer, GCPipelineLayoutPtr layout,
...
extern "C" GCError GCCommandSetViewport(GCCommandBufferPtr command_buffer, float x, float y,
...
extern "C" GCError GCCommandSetScissor(GCCommandBufferPtr command_buffer, uint32_t x, uint32_t y,
...
extern "C" GCError GCCommandDraw(GCCommandBufferPtr command_buffer, uint32_t vertex_count,
...
extern "C" GCError GCCommandDrawIndexed(GCCommandBufferPtr command_buffer, uint32_t index_count,
...
extern "C" GCError GCCommandDispatch(GCCommandBufferPtr command_buffer, uint32_t group_x,
...
extern "C" GCError GCCommandDispatchMesh(GCCommandBufferPtr command_buffer, uint32_t group_x,
                                         uint32_t group_y, uint32_t group_z) {
    if (!command_buffer) return invalid_argument("command_buffer is NULL");
...
extern "C" GCError GCCommandDispatchRays(GCCommandBufferPtr command_buffer, uint32_t width,
...
extern "C" GCError GCCommandResourceBarrier(GCCommandBufferPtr command_buffer, const GCBarrierDesc* desc) {
    if (!command_buffer || !desc) return invalid_argument("command_buffer or desc is NULL");
    ...
    for (uint32_t i = 0; i < desc->texture_barrier_count; i++) {
        ...
        bool is_depth = texture->desc.format == GC_FORMAT_D24S8 || texture->desc.format == GC_FORMAT_D32_FLOAT;
...
extern "C" GCError GCCommandCopyBuffer(GCCommandBufferPtr command_buffer,
                                        GCBufferPtr src_ptr, uint64_t src_offset,
                                        GCBufferPtr dst_ptr, uint64_t dst_offset,
                                        uint64_t size) {
