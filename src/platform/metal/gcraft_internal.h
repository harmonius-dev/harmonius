// gcraft_internal.h - Internal structures and utilities for Metal backend (C++
// / Metal-cpp) Requires macOS 15+/iOS 18+ for Metal 4 features
...
// Error helpers
inline GCError ep_ok() { return GCError{GC_E_OK, nullptr}; }
