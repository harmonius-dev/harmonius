...
impl ReplicationSystem {
    ...
    /// Updates debug overlay toggle polled once per tick.
    ...
    pub fn drain_acks(&self, tracker: &mut DeltaTracker) -> u32 {
        let mut count = 0u32;
...
mod tests {
    ...
    fn tc_ir_4_4_8_n2_ack_overflow_is_try_send_bounded() {
        ...
        let system = ReplicationSystem::new(rx);
    ...
    #[test]
    fn tc_ir_4_4_8_5_debug_toggle_flips_before_tick() {
    ...
    fn drain_acks_advances_baseline() {
        ...
        .expect("send");
        assert_eq!(system.drain_acks(&mut tracker), 1);
