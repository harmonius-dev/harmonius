...
### R-13.4.1 Gameplay Logic Graph Integration

The engine **SHALL** author all gameplay scripting through the universal logic graph system with
gameplay-specific integration points (ECS world state access, gameplay event emission/handling,
ability activation, state machine transitions, AI blackboard read/write), where gameplay graphs
attach to entities as components and execute in the ECS system schedule, with no text-based
scripting language provided.

- **Derived from:** [F-13.4.1](../../features/game-framework/scripting.md)
