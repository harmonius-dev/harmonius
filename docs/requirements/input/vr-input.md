...
skeleton, predefined gesture recognition, and auto-switching between controllers and hands, **so
that** hand tracking is available.

## US-6.5.3.8 Test Hand Tracking on Supported Headsets

**As a** QA tester (P-19), **I want to** test hand tracking on Quest and PC (via OpenXR), **so
that** hand tracking works on all supported headsets.
...
**As a** player (P-23), **I want** my controllers to vibrate when I reach near objects in VR, **so
that** I can feel the virtual world.
