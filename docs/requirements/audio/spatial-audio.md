...
**As an** audio designer (P-14), **I want to** adjust the Doppler effect strength per source, **so
that** fast-moving sounds have appropriate pitch shifts.
...
**As a** designer (P-5), **I want to** place and configure reverb zones in the level editor, **so
that** room acoustics are part of level design.
