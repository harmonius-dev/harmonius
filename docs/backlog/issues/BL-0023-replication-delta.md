...
`networking/network-transport.md` names delta compression for state replication but does not
choose an algorithm. Bit-packing, RLE, and rkyv-diff are candidates.
...
- [docs/user-stories/networking/non-functional.md](../../user-stories/networking/non-functional.md) US-8.NFR.2
