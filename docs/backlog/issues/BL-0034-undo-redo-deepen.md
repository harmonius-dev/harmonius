...
`tools/undo-redo.md` exists but covers only the basic stack. The 2026-04-12 review §3.7
P2 #52 recommended adding memory budget, persistent history, network sync for collaborative
undo, and gizmo selection coupling.
...
A 1-hour multi-user editing session retains undo history, respects the documented memory
budget, and reconciles concurrent edits.
