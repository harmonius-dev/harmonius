...
The 2026-05 audit identified user-story files with fewer than ten stories:
`event-logs.md` (8), `ui-rendering.md` (7), `localization-editor.md` (6),
`containers-slots.md` (10 borderline), `scripting.md` (8), `animation/first-person.md` (8).
