...
The 2026-04-12 review §3.8 listed `event-logs-animation` as a missing integration pair.
Event logs feed animation triggers (replay, AI memory animation, action history); no
integration doc specifies the contract.
