...
`physics/advanced.md` mentions fluid simulation but does not pick a solver. SPH (smoothed
particle hydrodynamics), FLIP / PIC, and Eulerian grid solvers each have different
trade-offs.
