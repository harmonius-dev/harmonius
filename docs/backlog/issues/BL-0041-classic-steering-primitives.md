...
`ai/steering-crowds.md` is missing classic steering primitives (`Align`, `Separate`,
`Cohesion` outside flocking, `ObstacleAvoid`, `Hide`, `Interpose`). The 2026-04-12 review
§3.6 / P2 #57 flagged this.
...
A flock of 100 agents with composed primitives behaves consistently with the documented
algorithms.
