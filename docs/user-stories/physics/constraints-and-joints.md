...
| ID | Persona |
|----|---------|
| US-4.3.1 | game developer (P-15) |
| US-4.3.10 | engine developer (P-26) |
| US-4.3.11 | game developer (P-15) |
| US-4.3.12 | game developer (P-15) |
| US-4.3.2 | game developer (P-15) |
| US-4.3.3 | game developer (P-15) |
| US-4.3.4 | game developer (P-15) |
| US-4.3.5 | game developer (P-15) |
| US-4.3.6 | game developer (P-15) |
| US-4.3.7 | engine developer (P-26) |
| US-4.3.8 | game developer (P-15) |
| US-4.3.9 | game developer (P-15) |

1. **US-4.3.1** -- **As a** game developer (P-15), **I want** the capabilities defined in
   sub-stories US-4.3.1.1 through US-4.3.1.2 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

2. **US-4.3.10** -- **As a** engine developer (P-26), **I want** the capabilities defined in
   sub-stories US-4.3.10.1 through US-4.3.10.1 combined into a single umbrella feature, **so that**
   I have a coherent parent story covering the refined child stories.

3. **US-4.3.11** -- **As a** game developer (P-15), **I want** the capabilities defined in
   sub-stories US-4.3.11.1 through US-4.3.11.1 combined into a single umbrella feature, **so that**
   I have a coherent parent story covering the refined child stories.

4. **US-4.3.12** -- **As a** game developer (P-15), **I want** the capabilities defined in
   sub-stories US-4.3.12.1 through US-4.3.12.1 combined into a single umbrella feature, **so that**
   I have a coherent parent story covering the refined child stories.

5. **US-4.3.2** -- **As a** game developer (P-15), **I want** the capabilities defined in
   sub-stories US-4.3.2.1 through US-4.3.2.2 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

6. **US-4.3.3** -- **As a** game developer (P-15), **I want** the capabilities defined in
   sub-stories US-4.3.3.1 through US-4.3.3.2 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

7. **US-4.3.4** -- **As a** game developer (P-15), **I want** the capabilities defined in
   sub-stories US-4.3.4.1 through US-4.3.4.2 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

8. **US-4.3.5** -- **As a** game developer (P-15), **I want** the capabilities defined in
   sub-stories US-4.3.5.1 through US-4.3.5.2 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

9. **US-4.3.6** -- **As a** game developer (P-15), **I want** the capabilities defined in
   sub-stories US-4.3.6.1 through US-4.3.6.2 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

10. **US-4.3.7** -- **As a** engine developer (P-26), **I want** the capabilities defined in
    sub-stories
US-4.3.7.1 through US-4.3.7.3 combined into a single umbrella feature, **so that** I have a coherent
parent story covering the refined child stories.

11. **US-4.3.8** -- **As a** game developer (P-15), **I want** the capabilities defined in
    sub-stories
US-4.3.8.1 through US-4.3.8.2 combined into a single umbrella feature, **so that** I have a coherent
parent story covering the refined child stories.

12. **US-4.3.9** -- **As a** game developer (P-15), **I want** the capabilities defined in
    sub-stories
US-4.3.9.1 through US-4.3.9.2 combined into a single umbrella feature, **so that** I have a coherent
parent story covering the refined child stories.
