...
**As an** audio designer (P-14), **I want to** configure Doppler scale factor per source,
**so that** Doppler intensity is tunable.
...
**As an** audio designer (P-14), **I want to** configure the portal graph in the visual editor,
**so that** propagation paths are visual.
...
**As an** audio designer (P-14), **I want to** author early reflection patterns per zone,
**so that** specific rooms have tailored acoustics.
