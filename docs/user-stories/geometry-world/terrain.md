...
**As a** level designer, **I want** a sparse voxel volume with SDF values and material IDs, **so
that** I can create caves, overhangs, arches, and underground spaces impossible with heightmaps
alone.
...
**As a** world artist, **I want** a spherical voxel volume with clipmap LOD and radial gravity, **so
that** I can create planets with seamless ground-to-orbit transitions.
