...
| ID | Persona |
|----|---------|
| US-3.3.1 | environment artist (P-8) |
| US-3.3.2 | environment artist (P-8) |
| US-3.3.3 | environment artist (P-8) |
| US-3.3.4 | environment artist (P-8) |
| US-3.3.5 | level designer (P-6) |
| US-3.3.6 | environment artist (P-8) |
| US-3.3.7 | environment artist (P-8) |
| US-3.3.8 | environment artist (P-8) |
| US-3.3.9 | engine developer (P-26) |

1. **US-3.3.1** -- **As a** environment artist (P-8), **I want** the capabilities defined in
   sub-stories US-3.3.1.1 through US-3.3.1.5 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

2. **US-3.3.2** -- **As a** environment artist (P-8), **I want** the capabilities defined in
   sub-stories US-3.3.2.1 through US-3.3.2.4 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

3. **US-3.3.3** -- **As a** environment artist (P-8), **I want** the capabilities defined in
   sub-stories US-3.3.3.1 through US-3.3.3.4 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

4. **US-3.3.4** -- **As a** environment artist (P-8), **I want** the capabilities defined in
   sub-stories US-3.3.4.1 through US-3.3.4.4 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

5. **US-3.3.5** -- **As a** level designer (P-6), **I want** the capabilities defined in sub-stories
   US-3.3.5.1 through US-3.3.5.4 combined into a single umbrella feature, **so that** I have a
   coherent parent story covering the refined child stories.

6. **US-3.3.6** -- **As a** environment artist (P-8), **I want** the capabilities defined in
   sub-stories US-3.3.6.1 through US-3.3.6.4 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

7. **US-3.3.7** -- **As a** environment artist (P-8), **I want** the capabilities defined in
   sub-stories US-3.3.7.1 through US-3.3.7.4 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

8. **US-3.3.8** -- **As a** environment artist (P-8), **I want** the capabilities defined in
   sub-stories US-3.3.8.1 through US-3.3.8.1 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.

9. **US-3.3.9** -- **As a** engine developer (P-26), **I want** the capabilities defined in
   sub-stories US-3.3.9.1 through US-3.3.9.1 combined into a single umbrella feature, **so that** I
   have a coherent parent story covering the refined child stories.
