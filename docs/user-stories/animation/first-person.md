...
8. **US-9.6.4.2** -- **As a** character animator (P-11), **I want** dual wielding with independent
   sway, bob, fire, and reload per hand, **so that** two-weapon combat feels responsive and
   distinct.
