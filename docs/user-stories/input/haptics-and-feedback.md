...
**As an** engine tester (P-27), **I want to** verify rumble on Xbox, DualSense, and Switch Pro, **so
that** all controllers produce haptic feedback.
...
**As an** engine developer (P-26), **I want** sectioned resistance for gear shifting notches, **so
that** vehicle gear changes are tactile.
...
**As a** designer (P-5), **I want to** author adaptive trigger effects in the visual editor, **so
that** trigger feel is tunable.
...
**As a** player (P-23), **I want** rain tapping on my shield to produce fine haptic feedback, **so
that** environmental effects are tactile.

## US-6.4.3.11 Test Waveform Format Conversion
**As an** engine tester (P-27), **I want to** test common-to-platform waveform conversion, **so
that** output matches on Joy-Con and DualSense.

## US-6.4.3.12 Verify Waveform Playback Timing
**As a** QA tester (P-19), **I want to** verify waveform playback timing matches keyframes, **so
that** haptic rhythm is accurate.
...
**As an** engine developer (P-26), **I want** frequency band extraction targeting 20-250 Hz, **so
that** haptic actuators receive perceptible frequencies.
...
**As an** engine developer (P-26), **I want** access to audio mix output for band extraction, **so
that** frequency data is accurate.
...
**As a** player (P-23), **I want** environmental rumble (thunder, machinery) to match audio, **so
that** ambient haptics are immersive.
...
**As an** engine developer (P-26), **I want** profile parameters bound to gameplay values, **so
that** intensity scales dynamically.
...
**As an** engine developer (P-26), **I want** impact force parameter bound to rumble intensity, **so
that** stronger hits produce stronger feedback.
