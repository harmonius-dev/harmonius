...
## US-13.15.1.3
**As a** player (P-23), **I want** my companion to teleport to me if they fall too far behind, **so
that** I never lose my companion due to pathing failures.
...
## US-13.15.2.8
**As a** tester (P-27), **I want** to verify that extended neglect causes the pet to run away, **so
that** the abandonment consequence triggers.
...
## US-13.15.3c.3
**As a** designer (P-5), **I want** to configure which abilities are allowed per mount type, **so
that** I can control mounted combat balance.
