...
**As a** player (P-23), **I want** pistons to push and pull adjacent blocks when powered,
**so that** I can build moving structures.
...
**so that** exploration is three-dimensional.
...
**As a** level designer (P-6), **I want** heightmap and cave noise configurable per world,
**so that** I can create diverse terrain profiles.
