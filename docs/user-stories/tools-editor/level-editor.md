...
nesting (e.g., a "village" prefab built from "house" prefabs containing "furniture" prefabs), **so
that** I can compose complex structures from modular building blocks.
