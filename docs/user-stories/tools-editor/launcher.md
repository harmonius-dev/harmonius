...
templates (RPG, FPS, RTS, 2D platformer, VR, empty), target platforms, and starter content, **so
that** projects start with pre-configured gameplay systems and input mappings.
