...
commands like "rotate it 10 degrees north" reference the previously created or selected object, **so
that** I can work naturally without repeating context.
...
**As a** modder (P-24), **I want** contextual action reminders that work in the mod SDK editor, **so
that** I can learn the subset of available tools without separate documentation.
