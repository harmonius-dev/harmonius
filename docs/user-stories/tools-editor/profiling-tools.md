...
**As a** DevOps engineer (P-16), **I want** memory profiling data available in CI reports,
**so that** automated tests can fail when a subsystem exceeds its allocated memory budget.
