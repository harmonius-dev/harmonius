...
opaque, non-resizable window without title chrome. The window point size is derived from a
hardcoded 1x snapshot scale so raw screenshots produce a consistent 1280×720 PNG baseline.
