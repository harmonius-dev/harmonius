...
**Current state (2026-05-20):** Requirements, features, and user stories are fully specified (1,648
requirements, 1,204+ features, 3,206 user stories across 17 domains). Build system is configured
(Rust stable, XcodeGen for macOS/iOS, Vulkan-only via `ash`). 77 subsystem design documents and 62
integration designs are in place under [docs/design/](../design/) (see
[architecture.md](../architecture.md) Design Summary). The canonical OSS server stack is documented
in [design/networking/network-infrastructure.md](../design/networking/network-infrastructure.md)
