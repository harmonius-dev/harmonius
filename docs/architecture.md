...
RG-14](README.md), the renderer features in [docs/features/](../../features/), and the core
architectural constraints in [1.1-core-constraints.md](../1-architecture/1.1-core-constraints.md).
