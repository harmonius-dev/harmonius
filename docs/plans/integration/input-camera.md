...
- Progress file: [PLAN-integration-input-camera.md](../progress/PLAN-integration-input-camera.md)

## Source documents

- Design: [input-camera.md](../../design/integration/input-camera.md)
- Test cases: [input-camera-test-cases.md](../../design/integration/input-camera-test-cases.md)
- Progress: [PLAN-integration-input-camera.md](../progress/PLAN-integration-input-camera.md)
...
- [input-camera-test-cases.md](../../design/integration/input-camera-test-cases.md)
