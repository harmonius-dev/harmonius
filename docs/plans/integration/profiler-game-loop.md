...
1. Open [progress file](../progress/PLAN-integration-profiler-game-loop.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-profiler-game-loop` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/profiler-game-loop.md](../../design/integration/profiler-game-loop.md) |
| Test Cases | [../../design/integration/profiler-game-loop-test-cases.md](../../design/integration/profiler-game-loop-test-cases.md) |
| Progress | [../progress/PLAN-integration-profiler-game-loop.md](../progress/PLAN-integration-profiler-game-loop.md) |
