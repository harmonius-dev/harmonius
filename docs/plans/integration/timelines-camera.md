...
1. Open [progress file](../progress/PLAN-integration-timelines-camera.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-timelines-camera` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/timelines-camera.md](../../design/integration/timelines-camera.md) |
| Test Cases | [../../design/integration/timelines-camera-test-cases.md](../../design/integration/timelines-camera-test-cases.md) |
| Progress | [../progress/PLAN-integration-timelines-camera.md](../progress/PLAN-integration-timelines-camera.md) |
