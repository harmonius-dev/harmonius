...
1. Open [progress file](../progress/PLAN-integration-networking-audio.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-networking-audio` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/networking-audio.md](../../design/integration/networking-audio.md) |
| Test Cases | [../../design/integration/networking-audio-test-cases.md](../../design/integration/networking-audio-test-cases.md) |
| Progress | [../progress/PLAN-integration-networking-audio.md](../progress/PLAN-integration-networking-audio.md) |
