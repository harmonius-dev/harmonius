...
1. Open [progress file](../progress/PLAN-integration-grids-volumes-physics.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-grids-volumes-physics` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/grids-volumes-physics.md](../../design/integration/grids-volumes-physics.md) |
| Test Cases | [../../design/integration/grids-volumes-physics-test-cases.md](../../design/integration/grids-volumes-physics-test-cases.md) |
| Progress | [../progress/PLAN-integration-grids-volumes-physics.md](../progress/PLAN-integration-grids-volumes-physics.md) |
