...
1. Open [progress file](../progress/PLAN-integration-physics-geometry.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-physics-geometry` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/physics-geometry.md](../../design/integration/physics-geometry.md) |
| Test Cases | [../../design/integration/physics-geometry-test-cases.md](../../design/integration/physics-geometry-test-cases.md) |
| Progress | [../progress/PLAN-integration-physics-geometry.md](../progress/PLAN-integration-physics-geometry.md) |
