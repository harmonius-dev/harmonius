...
1. Open [progress file](../progress/PLAN-integration-rendering-scripting.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-rendering-scripting` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/rendering-scripting.md](../../design/integration/rendering-scripting.md) |
| Test Cases | [../../design/integration/rendering-scripting-test-cases.md](../../design/integration/rendering-scripting-test-cases.md) |
| Progress | [../progress/PLAN-integration-rendering-scripting.md](../progress/PLAN-integration-rendering-scripting.md) |
