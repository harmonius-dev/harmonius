...
features: []
id: PLAN-integration-animation-vfx
name: Integration: Animation Vfx
parent: null
progress_file: docs/plans/progress/PLAN-integration-animation-vfx.md
requirements: []
status: not_started
test_cases: []
worktree_branch: plan/integration-animation-vfx
---

# Integration: Animation Vfx Implementation Plan

> **Plan ID:** `PLAN-integration-animation-vfx`
>
> **Agents:** Load the harmonize skill, then this progress file, before edits.

## Execution Instructions

1. Open [progress file](../progress/PLAN-integration-animation-vfx.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-animation-vfx` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/animation-vfx.md](../../design/integration/animation-vfx.md) |
| Test Cases | [../../design/integration/animation-vfx-test-cases.md](../../design/integration/animation-vfx-test-cases.md) |
| Progress | [../progress/PLAN-integration-animation-vfx.md](../progress/PLAN-integration-animation-vfx.md) |
