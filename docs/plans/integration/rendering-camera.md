...
1. Open [progress file](../progress/PLAN-integration-rendering-camera.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-rendering-camera` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/rendering-camera.md](../../design/integration/rendering-camera.md) |
| Test Cases | [../../design/integration/rendering-camera-test-cases.md](../../design/integration/rendering-camera-test-cases.md) |
| Progress | [../progress/PLAN-integration-rendering-camera.md](../progress/PLAN-integration-rendering-camera.md) |
