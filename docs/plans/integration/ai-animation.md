...
1. Open [progress file](../progress/PLAN-integration-ai-animation.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-ai-animation` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/ai-animation.md](../../design/integration/ai-animation.md) |
| Test Cases | [../../design/integration/ai-animation-test-cases.md](../../design/integration/ai-animation-test-cases.md) |
| Progress | [../progress/PLAN-integration-ai-animation.md](../progress/PLAN-integration-ai-animation.md) |
