...
dependencies: []
design_documents:
  - docs/design/integration/shared-conventions.md
execution_mode: sequential
features: []
id: PLAN-integration-shared-conventions
name: Integration: Shared Conventions
parent: null
progress_file: docs/plans/progress/PLAN-integration-shared-conventions.md
requirements: []
status: not_started
test_cases: []
worktree_branch: plan/integration-shared-conventions
---

# Integration: Shared Conventions Implementation Plan

> **Plan ID:** `PLAN-integration-shared-conventions`
>
> **Agents:** Load the harmonize skill, then this progress file, before edits.

## Execution Instructions

1. Open [progress file](../progress/PLAN-integration-shared-conventions.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-shared-conventions` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/shared-conventions.md](../../design/integration/shared-conventions.md) |
| Test Cases | (none — normative rules or umbrella doc) |
| Progress | [../progress/PLAN-integration-shared-conventions.md](../progress/PLAN-integration-shared-conventions.md) |
