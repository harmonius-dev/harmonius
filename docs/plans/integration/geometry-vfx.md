...
dependencies: []
design_documents:
  - docs/design/integration/geometry-vfx.md
execution_mode: sequential
features: []
id: PLAN-integration-geometry-vfx
name: Integration: Geometry Vfx
parent: null
progress_file: docs/plans/progress/PLAN-integration-geometry-vfx.md
requirements: []
status: not_started
test_cases: []
worktree_branch: plan/integration-geometry-vfx
---

# Integration: Geometry Vfx Implementation Plan

> **Plan ID:** `PLAN-integration-geometry-vfx`
>
> **Agents:** Load the harmonize skill, then this progress file, before edits.

## Execution Instructions

1. Open [progress file](../progress/PLAN-integration-geometry-vfx.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-geometry-vfx` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/geometry-vfx.md](../../design/integration/geometry-vfx.md) |
| Test Cases | [../../design/integration/geometry-vfx-test-cases.md](../../design/integration/geometry-vfx-test-cases.md) |
| Progress | [../progress/PLAN-integration-geometry-vfx.md](../progress/PLAN-integration-geometry-vfx.md) |
