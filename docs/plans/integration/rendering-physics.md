...
1. Open [progress file](../progress/PLAN-integration-rendering-physics.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-rendering-physics` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/rendering-physics.md](../../design/integration/rendering-physics.md) |
| Test Cases | [../../design/integration/rendering-physics-test-cases.md](../../design/integration/rendering-physics-test-cases.md) |
| Progress | [../progress/PLAN-integration-rendering-physics.md](../progress/PLAN-integration-rendering-physics.md) |
