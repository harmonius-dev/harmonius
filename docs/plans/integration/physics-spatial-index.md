...
1. Open [progress file](../progress/PLAN-integration-physics-spatial-index.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-physics-spatial-index` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/physics-spatial-index.md](../../design/integration/physics-spatial-index.md) |
| Test Cases | [../../design/integration/physics-spatial-index-test-cases.md](../../design/integration/physics-spatial-index-test-cases.md) |
| Progress | [../progress/PLAN-integration-physics-spatial-index.md](../progress/PLAN-integration-physics-spatial-index.md) |
