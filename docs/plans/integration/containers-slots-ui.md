...
1. Open [progress file](../progress/PLAN-integration-containers-slots-ui.md).
2. Create worktree `../harmonius-worktrees/PLAN-integration-containers-slots-ui` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/integration/containers-slots-ui.md](../../design/integration/containers-slots-ui.md) |
| Test Cases | [../../design/integration/containers-slots-ui-test-cases.md](../../design/integration/containers-slots-ui-test-cases.md) |
| Progress | [../progress/PLAN-integration-containers-slots-ui.md](../progress/PLAN-integration-containers-slots-ui.md) |
