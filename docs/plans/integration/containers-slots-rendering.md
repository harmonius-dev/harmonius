...
- Progress file:
  [PLAN-integration-containers-slots-rendering.md](../progress/PLAN-integration-containers-slots-rendering.md)

## Source documents

- Design: [containers-slots-rendering.md](../../design/integration/containers-slots-rendering.md)
- Test cases:
  [containers-slots-rendering-test-cases.md](../../design/integration/containers-slots-rendering-test-cases.md)
- Progress:
  [PLAN-integration-containers-slots-rendering.md](../progress/PLAN-integration-containers-slots-rendering.md)
