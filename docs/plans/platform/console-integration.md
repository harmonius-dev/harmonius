...
1. Open [progress file](../progress/PLAN-platform-console-integration.md).
2. Create worktree `../harmonius-worktrees/PLAN-platform-console-integration` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/platform/console-integration.md](../../design/platform/console-integration.md) |
| Test Cases | [../../design/platform/console-integration-test-cases.md](../../design/platform/console-integration-test-cases.md) |
| Progress | [../progress/PLAN-platform-console-integration.md](../progress/PLAN-platform-console-integration.md) |
