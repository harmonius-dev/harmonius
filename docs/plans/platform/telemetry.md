...
1. Open [progress file](../progress/PLAN-platform-telemetry.md).
2. Create worktree `../harmonius-worktrees/PLAN-platform-telemetry` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/platform/telemetry.md](../../design/platform/telemetry.md) |
| Test Cases | [../../design/platform/telemetry-test-cases.md](../../design/platform/telemetry-test-cases.md) |
| Progress | [../progress/PLAN-platform-telemetry.md](../progress/PLAN-platform-telemetry.md) |
