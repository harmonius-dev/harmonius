...
1. Open [progress file](../progress/PLAN-platform-threading.md).
2. Create worktree `../harmonius-worktrees/PLAN-platform-threading` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/platform/threading.md](../../design/platform/threading.md) |
| Test Cases | [../../design/platform/threading-test-cases.md](../../design/platform/threading-test-cases.md) |
| Progress | [../progress/PLAN-platform-threading.md](../progress/PLAN-platform-threading.md) |
