...
1. Open [progress file](../progress/PLAN-platform-windowing.md).
2. Create worktree `../harmonius-worktrees/PLAN-platform-windowing` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/platform/windowing.md](../../design/platform/windowing.md) |
| Test Cases | [../../design/platform/windowing-test-cases.md](../../design/platform/windowing-test-cases.md) |
| Progress | [../progress/PLAN-platform-windowing.md](../progress/PLAN-platform-windowing.md) |
