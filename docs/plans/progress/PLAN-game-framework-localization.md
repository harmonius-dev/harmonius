...
last_updated: 2026-04-14T05:18:20Z
...
- Test reports: `cargo test -p harmonius_localization` in worktree (19 unit tests).
...
- Videos: deferred.
- Review notes: initial implementation is library-only (no ECS wiring); integration TCs deferred.
