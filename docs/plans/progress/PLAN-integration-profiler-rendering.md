...
last_updated: 2026-04-14T05:20:06Z
...
- Test reports: `cargo test --workspace` (9 unit + 3 integration tests) in worktree
  `PLAN-integration-profiler-rendering` at commit `eb0651d`.
...
- Review notes: headless `QueryPool` fake covers CI-runnable rows from
  `profiler-rendering-test-cases.md`; full render-graph wiring remains follow-on once the engine
  graph executes in-tree.
