...
1. Open [progress file](../progress/PLAN-tools-build-deploy.md).
2. Create worktree `../harmonius-worktrees/PLAN-tools-build-deploy` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/tools/build-deploy.md](../../design/tools/build-deploy.md) |
| Test Cases | [../../design/tools/build-deploy-test-cases.md](../../design/tools/build-deploy-test-cases.md) |
| Progress | [../progress/PLAN-tools-build-deploy.md](../progress/PLAN-tools-build-deploy.md) |
