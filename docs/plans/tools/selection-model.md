...
1. Open [progress file](../progress/PLAN-tools-selection-model.md).
2. Create worktree `../harmonius-worktrees/PLAN-tools-selection-model` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/tools/selection-model.md](../../design/tools/selection-model.md) |
| Test Cases | [../../design/tools/selection-model-test-cases.md](../../design/tools/selection-model-test-cases.md) |
| Progress | [../progress/PLAN-tools-selection-model.md](../progress/PLAN-tools-selection-model.md) |
