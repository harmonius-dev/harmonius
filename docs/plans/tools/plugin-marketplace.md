...
1. Open [progress file](../progress/PLAN-tools-plugin-marketplace.md).
2. Create worktree `../harmonius-worktrees/PLAN-tools-plugin-marketplace` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/tools/plugin-marketplace.md](../../design/tools/plugin-marketplace.md) |
| Test Cases | [../../design/tools/plugin-marketplace-test-cases.md](../../design/tools/plugin-marketplace-test-cases.md) |
| Progress | [../progress/PLAN-tools-plugin-marketplace.md](../progress/PLAN-tools-plugin-marketplace.md) |
