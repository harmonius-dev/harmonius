...
1. Open [progress file](../progress/PLAN-tools-level-world.md).
2. Create worktree `../harmonius-worktrees/PLAN-tools-level-world` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/tools/level-world.md](../../design/tools/level-world.md) |
| Test Cases | [../../design/tools/level-world-test-cases.md](../../design/tools/level-world-test-cases.md) |
| Progress | [../progress/PLAN-tools-level-world.md](../progress/PLAN-tools-level-world.md) |
