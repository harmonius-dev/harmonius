...
1. Open [progress file](../progress/PLAN-tools-content-services.md).
2. Create worktree `../harmonius-worktrees/PLAN-tools-content-services` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/tools/content-services.md](../../design/tools/content-services.md) |
| Test Cases | [../../design/tools/content-services-test-cases.md](../../design/tools/content-services-test-cases.md) |
| Progress | [../progress/PLAN-tools-content-services.md](../progress/PLAN-tools-content-services.md) |
