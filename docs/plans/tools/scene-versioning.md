...
1. Open [progress file](../progress/PLAN-tools-scene-versioning.md).
2. Create worktree `../harmonius-worktrees/PLAN-tools-scene-versioning` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/tools/scene-versioning.md](../../design/tools/scene-versioning.md) |
| Test Cases | [../../design/tools/scene-versioning-test-cases.md](../../design/tools/scene-versioning-test-cases.md) |
| Progress | [../progress/PLAN-tools-scene-versioning.md](../progress/PLAN-tools-scene-versioning.md) |
