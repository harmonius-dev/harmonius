...
1. Open [progress file](../progress/PLAN-game-framework-camera.md).
2. Create worktree `../harmonius-worktrees/PLAN-game-framework-camera` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/game-framework/camera.md](../../design/game-framework/camera.md) |
| Test Cases | [../../design/game-framework/camera-test-cases.md](../../design/game-framework/camera-test-cases.md) |
| Progress | [../progress/PLAN-game-framework-camera.md](../progress/PLAN-game-framework-camera.md) |
