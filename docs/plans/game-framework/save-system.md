...
1. Open [progress file](../progress/PLAN-game-framework-save-system.md).
2. Create worktree `../harmonius-worktrees/PLAN-game-framework-save-system` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/game-framework/save-system.md](../../design/game-framework/save-system.md) |
| Test Cases | [../../design/game-framework/save-system-test-cases.md](../../design/game-framework/save-system-test-cases.md) |
| Progress | [../progress/PLAN-game-framework-save-system.md](../progress/PLAN-game-framework-save-system.md) |
