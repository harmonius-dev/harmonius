...
1. Open [progress file](../progress/PLAN-game-framework-scripting.md).
2. Create worktree `../harmonius-worktrees/PLAN-game-framework-scripting` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/game-framework/scripting.md](../../design/game-framework/scripting.md) |
| Test Cases | [../../design/game-framework/scripting-test-cases.md](../../design/game-framework/scripting-test-cases.md) |
| Progress | [../progress/PLAN-game-framework-scripting.md](../progress/PLAN-game-framework-scripting.md) |
