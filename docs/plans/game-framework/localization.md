...
1. Open [progress file](../progress/PLAN-game-framework-localization.md).
2. Create worktree `../harmonius-worktrees/PLAN-game-framework-localization` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/game-framework/localization.md](../../design/game-framework/localization.md) |
| Test Cases | [../../design/game-framework/localization-test-cases.md](../../design/game-framework/localization-test-cases.md) |
| Progress | [../progress/PLAN-game-framework-localization.md](../progress/PLAN-game-framework-localization.md) |
