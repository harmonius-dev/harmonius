...
1. Open [progress file](../progress/PLAN-animation-state-machine.md).
2. Create worktree `../harmonius-worktrees/PLAN-animation-state-machine` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/animation/state-machine.md](../../design/animation/state-machine.md) |
| Test Cases | [../../design/animation/state-machine-test-cases.md](../../design/animation/state-machine-test-cases.md) |
| Progress | [../progress/PLAN-animation-state-machine.md](../progress/PLAN-animation-state-machine.md) |
