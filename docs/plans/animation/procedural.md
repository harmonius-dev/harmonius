...
1. Open [progress file](../progress/PLAN-animation-procedural.md).
2. Create worktree `../harmonius-worktrees/PLAN-animation-procedural` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/animation/procedural.md](../../design/animation/procedural.md) |
| Test Cases | [../../design/animation/procedural-test-cases.md](../../design/animation/procedural-test-cases.md) |
| Progress | [../progress/PLAN-animation-procedural.md](../progress/PLAN-animation-procedural.md) |
