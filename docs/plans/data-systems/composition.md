...
1. Open [progress file](../progress/PLAN-data-systems-composition.md).
2. Create worktree `../harmonius-worktrees/PLAN-data-systems-composition` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/data-systems/composition.md](../../design/data-systems/composition.md) |
| Test Cases | [../../design/data-systems/composition-test-cases.md](../../design/data-systems/composition-test-cases.md) |
| Progress | [../progress/PLAN-data-systems-composition.md](../progress/PLAN-data-systems-composition.md) |
