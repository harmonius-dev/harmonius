...
1. Open [progress file](../progress/PLAN-data-systems-directed-graphs.md).
2. Create worktree `../harmonius-worktrees/PLAN-data-systems-directed-graphs` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/data-systems/directed-graphs.md](../../design/data-systems/directed-graphs.md) |
| Test Cases | [../../design/data-systems/directed-graphs-test-cases.md](../../design/data-systems/directed-graphs-test-cases.md) |
| Progress | [../progress/PLAN-data-systems-directed-graphs.md](../progress/PLAN-data-systems-directed-graphs.md) |
