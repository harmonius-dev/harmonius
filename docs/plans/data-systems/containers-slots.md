...
1. Open [progress file](../progress/PLAN-data-systems-containers-slots.md).
2. Create worktree `../harmonius-worktrees/PLAN-data-systems-containers-slots` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/data-systems/containers-slots.md](../../design/data-systems/containers-slots.md) |
| Test Cases | [../../design/data-systems/containers-slots-test-cases.md](../../design/data-systems/containers-slots-test-cases.md) |
| Progress | [../progress/PLAN-data-systems-containers-slots.md](../progress/PLAN-data-systems-containers-slots.md) |
