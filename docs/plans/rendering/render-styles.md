...
1. Open [progress file](../progress/PLAN-rendering-render-styles.md).
2. Create worktree `../harmonius-worktrees/PLAN-rendering-render-styles` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/rendering/render-styles.md](../../design/rendering/render-styles.md) |
| Test Cases | [../../design/rendering/render-styles-test-cases.md](../../design/rendering/render-styles-test-cases.md) |
| Progress | [../progress/PLAN-rendering-render-styles.md](../progress/PLAN-rendering-render-styles.md) |
