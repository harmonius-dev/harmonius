...
1. Open [progress file](../progress/PLAN-rendering-pipeline-state-cache.md).
2. Create worktree `../harmonius-worktrees/PLAN-rendering-pipeline-state-cache` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/rendering/pipeline-state-cache.md](../../design/rendering/pipeline-state-cache.md) |
| Test Cases | [../../design/rendering/pipeline-state-cache-test-cases.md](../../design/rendering/pipeline-state-cache-test-cases.md) |
| Progress | [../progress/PLAN-rendering-pipeline-state-cache.md](../progress/PLAN-rendering-pipeline-state-cache.md) |
