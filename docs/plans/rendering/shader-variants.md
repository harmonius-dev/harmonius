...
1. Open [progress file](../progress/PLAN-rendering-shader-variants.md).
2. Create worktree `../harmonius-worktrees/PLAN-rendering-shader-variants` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/rendering/shader-variants.md](../../design/rendering/shader-variants.md) |
| Test Cases | [../../design/rendering/shader-variants-test-cases.md](../../design/rendering/shader-variants-test-cases.md) |
| Progress | [../progress/PLAN-rendering-shader-variants.md](../progress/PLAN-rendering-shader-variants.md) |
