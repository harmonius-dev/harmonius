...
1. Open [progress file](../progress/PLAN-rendering-render-pipeline.md).
2. Create worktree `../harmonius-worktrees/PLAN-rendering-render-pipeline` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/rendering/render-pipeline.md](../../design/rendering/render-pipeline.md) |
| Test Cases | [../../design/rendering/render-pipeline-test-cases.md](../../design/rendering/render-pipeline-test-cases.md) |
| Progress | [../progress/PLAN-rendering-render-pipeline.md](../progress/PLAN-rendering-render-pipeline.md) |
