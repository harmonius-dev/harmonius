...
1. Open [progress file](../progress/PLAN-rendering-render-effects.md).
2. Create worktree `../harmonius-worktrees/PLAN-rendering-render-effects` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/rendering/render-effects.md](../../design/rendering/render-effects.md) |
| Test Cases | [../../design/rendering/render-effects-test-cases.md](../../design/rendering/render-effects-test-cases.md) |
| Progress | [../progress/PLAN-rendering-render-effects.md](../progress/PLAN-rendering-render-effects.md) |
