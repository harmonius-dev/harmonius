...
1. Open [progress file](../progress/PLAN-rendering-meshlets.md).
2. Create worktree `../harmonius-worktrees/PLAN-rendering-meshlets` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/rendering/meshlets.md](../../design/rendering/meshlets.md) |
| Test Cases | [../../design/rendering/meshlets-test-cases.md](../../design/rendering/meshlets-test-cases.md) |
| Progress | [../progress/PLAN-rendering-meshlets.md](../progress/PLAN-rendering-meshlets.md) |
