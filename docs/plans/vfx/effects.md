...
1. Open [progress file](../progress/PLAN-vfx-effects.md).
2. Create worktree `../harmonius-worktrees/PLAN-vfx-effects` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/vfx/effects.md](../../design/vfx/effects.md) |
| Test Cases | [../../design/vfx/effects-test-cases.md](../../design/vfx/effects-test-cases.md) |
| Progress | [../progress/PLAN-vfx-effects.md](../progress/PLAN-vfx-effects.md) |
