...
1. Open [progress file](../progress/PLAN-vfx-particles.md).
2. Create worktree `../harmonius-worktrees/PLAN-vfx-particles` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/vfx/particles.md](../../design/vfx/particles.md) |
| Test Cases | [../../design/vfx/particles-test-cases.md](../../design/vfx/particles-test-cases.md) |
| Progress | [../progress/PLAN-vfx-particles.md](../progress/PLAN-vfx-particles.md) |
