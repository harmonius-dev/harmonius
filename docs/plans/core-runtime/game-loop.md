...
features: []
id: PLAN-core-runtime-game-loop
name: Game Loop
parent: null
progress_file: docs/plans/progress/PLAN-core-runtime-game-loop.md
requirements: []
status: not_started
test_cases: []
worktree_branch: plan/core-runtime-game-loop
---

# Game Loop Implementation Plan

> **Plan ID:** `PLAN-core-runtime-game-loop`
>
> **Agents:** Load the harmonize skill, then this progress file, before edits.

## Execution Instructions

1. Open [progress file](../progress/PLAN-core-runtime-game-loop.md).
2. Create worktree `../harmonius-worktrees/PLAN-core-runtime-game-loop` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/core-runtime/game-loop.md](../../design/core-runtime/game-loop.md) |
| Test Cases | [../../design/core-runtime/game-loop-test-cases.md](../../design/core-runtime/game-loop-test-cases.md) |
| Progress | [../progress/PLAN-core-runtime-game-loop.md](../progress/PLAN-core-runtime-game-loop.md) |
