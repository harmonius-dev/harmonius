...
features:
  ...
  - F-1.9.8
  - F-1.9.9
id: PLAN-core-runtime-spatial-index
name: Spatial Index
parent: null
progress_file: docs/plans/progress/PLAN-core-runtime-spatial-index.md
requirements:
  - R-1.9.1
  - R-1.9.2
  - R-1.9.3
...
test_cases:
  ...
  - TC-1.9.4.6
  - TC-1.9.4.7
worktree_branch: plan/core-runtime-spatial-index
---

# Spatial Index implementation plan

- Plan ID: `PLAN-core-runtime-spatial-index`
- Progress file:
  [PLAN-core-runtime-spatial-index.md](../progress/PLAN-core-runtime-spatial-index.md)

## Source documents

- Design: [spatial-index.md](../../design/core-runtime/spatial-index.md)
- Test cases: [spatial-index-test-cases.md](../../design/core-runtime/spatial-index-test-cases.md)
- Progress: [PLAN-core-runtime-spatial-index.md](../progress/PLAN-core-runtime-spatial-index.md)
