...
1. Open [progress file](../progress/PLAN-physics-foundation.md).
2. Create worktree `../harmonius-worktrees/PLAN-physics-foundation` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/physics/foundation.md](../../design/physics/foundation.md) |
| Test Cases | [../../design/physics/foundation-test-cases.md](../../design/physics/foundation-test-cases.md) |
| Progress | [../progress/PLAN-physics-foundation.md](../progress/PLAN-physics-foundation.md) |
