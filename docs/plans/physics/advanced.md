...
1. Open [progress file](../progress/PLAN-physics-advanced.md).
2. Create worktree `../harmonius-worktrees/PLAN-physics-advanced` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/physics/advanced.md](../../design/physics/advanced.md) |
| Test Cases | [../../design/physics/advanced-test-cases.md](../../design/physics/advanced-test-cases.md) |
| Progress | [../progress/PLAN-physics-advanced.md](../progress/PLAN-physics-advanced.md) |
