...
1. Open [progress file](../progress/PLAN-simulation-timelines.md).
2. Create worktree `../harmonius-worktrees/PLAN-simulation-timelines` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/simulation/timelines.md](../../design/simulation/timelines.md) |
| Test Cases | [../../design/simulation/timelines-test-cases.md](../../design/simulation/timelines-test-cases.md) |
| Progress | [../progress/PLAN-simulation-timelines.md](../progress/PLAN-simulation-timelines.md) |
