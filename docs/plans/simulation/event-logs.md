...
1. Open [progress file](../progress/PLAN-simulation-event-logs.md).
2. Create worktree `../harmonius-worktrees/PLAN-simulation-event-logs` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/simulation/event-logs.md](../../design/simulation/event-logs.md) |
| Test Cases | [../../design/simulation/event-logs-test-cases.md](../../design/simulation/event-logs-test-cases.md) |
| Progress | [../progress/PLAN-simulation-event-logs.md](../progress/PLAN-simulation-event-logs.md) |
