...
1. Open [progress file](../progress/PLAN-simulation-grids-volumes.md).
2. Create worktree `../harmonius-worktrees/PLAN-simulation-grids-volumes` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/simulation/grids-volumes.md](../../design/simulation/grids-volumes.md) |
| Test Cases | [../../design/simulation/grids-volumes-test-cases.md](../../design/simulation/grids-volumes-test-cases.md) |
| Progress | [../progress/PLAN-simulation-grids-volumes.md](../progress/PLAN-simulation-grids-volumes.md) |
