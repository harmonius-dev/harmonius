...
1. Open [progress file](../progress/PLAN-simulation-spatial-awareness.md).
2. Create worktree `../harmonius-worktrees/PLAN-simulation-spatial-awareness` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/simulation/spatial-awareness.md](../../design/simulation/spatial-awareness.md) |
| Test Cases | [../../design/simulation/spatial-awareness-test-cases.md](../../design/simulation/spatial-awareness-test-cases.md) |
| Progress | [../progress/PLAN-simulation-spatial-awareness.md](../progress/PLAN-simulation-spatial-awareness.md) |
