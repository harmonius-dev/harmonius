...
1. Open [progress file](../progress/PLAN-simulation-game-loop-phases.md).
2. Create worktree `../harmonius-worktrees/PLAN-simulation-game-loop-phases` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/simulation/game-loop-phases.md](../../design/simulation/game-loop-phases.md) |
| Test Cases | [../../design/simulation/game-loop-phases-test-cases.md](../../design/simulation/game-loop-phases-test-cases.md) |
| Progress | [../progress/PLAN-simulation-game-loop-phases.md](../progress/PLAN-simulation-game-loop-phases.md) |
