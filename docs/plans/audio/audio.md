...
1. Open [progress file](../progress/PLAN-audio-audio.md).
2. Create worktree `../harmonius-worktrees/PLAN-audio-audio` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/audio/audio.md](../../design/audio/audio.md) |
| Test Cases | [../../design/audio/audio-test-cases.md](../../design/audio/audio-test-cases.md) |
| Progress | [../progress/PLAN-audio-audio.md](../progress/PLAN-audio-audio.md) |
