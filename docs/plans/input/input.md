...
1. Open [progress file](../progress/PLAN-input-input.md).
2. Create worktree `../harmonius-worktrees/PLAN-input-input` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/input/input.md](../../design/input/input.md) |
| Test Cases | [../../design/input/input-test-cases.md](../../design/input/input-test-cases.md) |
| Progress | [../progress/PLAN-input-input.md](../progress/PLAN-input-input.md) |
