...
1. Open [progress file](../progress/PLAN-ai-steering-crowds.md).
2. Create worktree `../harmonius-worktrees/PLAN-ai-steering-crowds` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/ai/steering-crowds.md](../../design/ai/steering-crowds.md) |
| Test Cases | [../../design/ai/steering-crowds-test-cases.md](../../design/ai/steering-crowds-test-cases.md) |
| Progress | [../progress/PLAN-ai-steering-crowds.md](../progress/PLAN-ai-steering-crowds.md) |
