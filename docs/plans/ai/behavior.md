...
1. Open [progress file](../progress/PLAN-ai-behavior.md).
2. Create worktree `../harmonius-worktrees/PLAN-ai-behavior` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/ai/behavior.md](../../design/ai/behavior.md) |
| Test Cases | [../../design/ai/behavior-test-cases.md](../../design/ai/behavior-test-cases.md) |
| Progress | [../progress/PLAN-ai-behavior.md](../progress/PLAN-ai-behavior.md) |
