...
1. Open [progress file](../progress/PLAN-ai-navigation.md).
2. Create worktree `../harmonius-worktrees/PLAN-ai-navigation` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/ai/navigation.md](../../design/ai/navigation.md) |
| Test Cases | [../../design/ai/navigation-test-cases.md](../../design/ai/navigation-test-cases.md) |
| Progress | [../progress/PLAN-ai-navigation.md](../progress/PLAN-ai-navigation.md) |
