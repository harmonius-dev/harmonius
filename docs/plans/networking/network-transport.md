...
1. Open [progress file](../progress/PLAN-networking-network-transport.md).
2. Create worktree `../harmonius-worktrees/PLAN-networking-network-transport` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/networking/network-transport.md](../../design/networking/network-transport.md) |
| Test Cases | [../../design/networking/network-transport-test-cases.md](../../design/networking/network-transport-test-cases.md) |
| Progress | [../progress/PLAN-networking-network-transport.md](../progress/PLAN-networking-network-transport.md) |
