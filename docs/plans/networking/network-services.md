...
1. Open [progress file](../progress/PLAN-networking-network-services.md).
2. Create worktree `../harmonius-worktrees/PLAN-networking-network-services` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/networking/network-services.md](../../design/networking/network-services.md) |
| Test Cases | [../../design/networking/network-services-test-cases.md](../../design/networking/network-services-test-cases.md) |
| Progress | [../progress/PLAN-networking-network-services.md](../progress/PLAN-networking-network-services.md) |
