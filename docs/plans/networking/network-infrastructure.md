...
1. Open [progress file](../progress/PLAN-networking-network-infrastructure.md).
2. Create worktree `../harmonius-worktrees/PLAN-networking-network-infrastructure` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/networking/network-infrastructure.md](../../design/networking/network-infrastructure.md) |
| Test Cases | [../../design/networking/network-infrastructure-test-cases.md](../../design/networking/network-infrastructure-test-cases.md) |
| Progress | [../progress/PLAN-networking-network-infrastructure.md](../progress/PLAN-networking-network-infrastructure.md) |
