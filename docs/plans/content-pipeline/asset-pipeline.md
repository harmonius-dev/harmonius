...
1. Open [progress file](../progress/PLAN-content-pipeline-asset-pipeline.md).
2. Create worktree `../harmonius-worktrees/PLAN-content-pipeline-asset-pipeline` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/content-pipeline/asset-pipeline.md](../../design/content-pipeline/asset-pipeline.md) |
| Test Cases | [../../design/content-pipeline/asset-pipeline-test-cases.md](../../design/content-pipeline/asset-pipeline-test-cases.md) |
| Progress | [../progress/PLAN-content-pipeline-asset-pipeline.md](../progress/PLAN-content-pipeline-asset-pipeline.md) |
