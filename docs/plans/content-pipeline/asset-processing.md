...
1. Open [progress file](../progress/PLAN-content-pipeline-asset-processing.md).
2. Create worktree `../harmonius-worktrees/PLAN-content-pipeline-asset-processing` per template.
...
| Document | Path |
|----------|------|
| Design | [../../design/content-pipeline/asset-processing.md](../../design/content-pipeline/asset-processing.md) |
| Test Cases | [../../design/content-pipeline/asset-processing-test-cases.md](../../design/content-pipeline/asset-processing-test-cases.md) |
| Progress | [../progress/PLAN-content-pipeline-asset-processing.md](../progress/PLAN-content-pipeline-asset-processing.md) |
